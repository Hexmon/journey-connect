...
export const mockPins: Pin[] = [
  ...
  },
  {
    ...
    type: "friend",
    title: "Sarah K.",
    description: "Online now • Last seen at Coffee & Co-work",
    distance: "1.2km away",
    time: "Active now",
    attendees: 0,
    host: "Sarah K.",
    location: { lat: 0.005, lng: 0.006 },
  },
  {
    id: "10",
    type: "friend",
    title: "Priya S.",
    description: "Studying at library • Available for study session",
    distance: "900m away",
    time: "Active 5m ago",
    attendees: 0,
    host: "Priya S.",
    location: { lat: -0.006, lng: -0.003 },
  },
  {
    id: "11",
    type: "friend",
    title: "Rohan M.",
    description: "At cricket ground • Practicing for Sunday match",
    distance: "1.5km away",
    time: "Active 15m ago",
    attendees: 0,
    host: "Rohan M.",
    location: { lat: 0.009, lng: 0.011 },
  },
];
